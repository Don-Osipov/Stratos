<template>
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <h3>Privacy Policy of Stratos</h3>
      <div>
        <p>Stratos operates the stratos.tl website.</p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the Stratos website.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at stratos.tl, unless
